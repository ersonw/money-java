...
public class ConvertUtils {
    ...
    public static <T> T getObject(Object object, Class<T> clazz){
        return JSONObject.toJavaObject(JSONObject.parseObject(JSONObject.toJSONString(object)),clazz);
    }
    public static <T> List<T> getObject(Objects object, Class<T> clazz){
